...
static void *TYCWebBrowserContext = &TYCWebBrowserContext;

@interface TYCWebView ()<UIAlertViewDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if(self.wkWebView) {
            ...
            [self.wkWebView addObserver:self forKeyPath:NSStringFromSelector(@selector(estimatedProgress)) options:0 context:TYCWebBrowserContext];
        }
        else  {
...
- (void)webViewDidStartLoad:(UIWebView *)webView
{
    if(webView == self.uiWebView) {
        [self.delegate tycwebViewDidStartLoad:self];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if(webView == self.uiWebView) {
        ...
        if(![self externalAppRequiredToOpenURL:request.URL]) {
            ...
            //back delegate
            [self.delegate tycwebView:self shouldStartLoadWithURL:request.URL];
            return YES;
        }
        else {
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    if(webView == self.uiWebView) {
        ...
        //back delegate
        [self.delegate tycwebView:self didFinishLoadingURL:self.uiWebView.request.URL];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    ...
    if(webView == self.uiWebView) {
        ...
        //back delegate
        [self.delegate tycwebView:self didFailToLoadURL:self.uiWebView.request.URL error:error];
    }
}
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    ...
    if(webView == self.wkWebView) {
        ...
        //back delegate
        [self.delegate tycwebView:self didFinishLoadingURL:self.wkWebView.URL];
    }
}
...
- (void)webView:(WKWebView *)webView didFailProvisionalNavigation:(WKNavigation *)navigation
    ...
    if(webView == self.wkWebView) {
        //back delegate
        [self.delegate tycwebView:self didFailToLoadURL:self.wkWebView.URL error:error];
    }
